...
PRODUCT_POOL = [
    ...
    {
        "asin": "B09W2PNZQQ",
        "name": "TP-Link WiFi 無線LAN ルーター AX3000 WiFi6対応",
        "url": f"https://www.amazon.co.jp/dp/B09W2PNZQQ?tag={_TAG}",
        "keywords": ["WiFiルーター", "WiFi6", "テレワーク", "一人暮らし"],
        "category": "gadget",
    },
    {
        "asin": "B0BQZPFQ2X",
        "name": "Anker 622 Magnetic Battery MagGo 5000mAh MagSafe対応",
        "url": f"https://www.amazon.co.jp/dp/B0BQZPFQ2X?tag={_TAG}",
        "keywords": ["MagSafe", "モバイルバッテリー", "iPhone", "ワイヤレス充電"],
        "category": "gadget",
    },
    {
        "asin": "B0C4BXHX2V",
        "name": "Baseus 67W USB-C GaN充電器 コンパクト 急速充電",
        "url": f"https://www.amazon.co.jp/dp/B0C4BXHX2V?tag={_TAG}",
        "keywords": ["GaN充電器", "急速充電", "コンパクト", "USB-C"],
        "category": "gadget",
    },
    {
        "asin": "B0BX4MQ3GY",
        "name": "Logicool MX MASTER 3S パフォーマンスワイヤレスマウス",
        "url": f"https://www.amazon.co.jp/dp/B0BX4MQ3GY?tag={_TAG}",
        "keywords": ["マウス", "ワイヤレスマウス", "テレワーク", "Logicool"],
        "category": "gadget",
    },
    {
        "asin": "B0BJKCS73T",
        "name": "UGREEN USB-C ハブ 10-in-1 ドッキングステーション 4K HDMI",
        "url": f"https://www.amazon.co.jp/dp/B0BJKCS73T?tag={_TAG}",
        "keywords": ["USBハブ", "ドッキングステーション", "MacBook", "テレワーク"],
        "category": "gadget",
    },
    {
        "asin": "B08N5WRWNW",
        "name": "Anker PowerCore 10000 モバイルバッテリー 軽量コンパクト",
        "url": f"https://www.amazon.co.jp/dp/B08N5WRWNW?tag={_TAG}",
        "keywords": ["モバイルバッテリー", "Anker", "軽量", "一人暮らし"],
        "category": "gadget",
    },
    {
        "asin": "B09JQMJHXY",
        "name": "Echo Dot 第5世代 スマートスピーカー with Alexa",
        "url": f"https://www.amazon.co.jp/dp/B09JQMJHXY?tag={_TAG}",
        "keywords": ["スマートスピーカー", "Alexa", "スマートホーム", "Echo"],
        "category": "gadget",
    },
    {
        "asin": "B0C6GYLGYB",
        "name": "Kindle Paperwhite 電子書籍リーダー 防水 グレア軽減",
        "url": f"https://www.amazon.co.jp/dp/B0C6GYLGYB?tag={_TAG}",
        "keywords": ["Kindle", "電子書籍", "読書", "一人暮らし"],
        "category": "gadget",
    },
    ...
    {
        "asin": "B086WKWDKJ",
        "name": "Logicool C920n HD Pro ウェブカメラ フルHD 1080p",
        "url": f"https://www.amazon.co.jp/dp/B086WKWDKJ?tag={_TAG}",
        "keywords": ["ウェブカメラ", "テレワーク", "Logicool", "Web会議"],
        "category": "gadget",
    },
    {
        "asin": "B09754MNQT",
        "name": "Fire TV Stick 4K Max ストリーミングメディアプレーヤー",
        "url": f"https://www.amazon.co.jp/dp/B09754MNQT?tag={_TAG}",
        "keywords": ["Fire TV", "ストリーミング", "4K", "一人暮らし"],
        "category": "gadget",
    },
    ...
    {
        "asin": "B07V9FHK2D",
        "name": "TP-Link Tapo C200 スマート防犯カメラ Wi-Fi 360度",
        "url": f"https://www.amazon.co.jp/dp/B07V9FHK2D?tag={_TAG}",
        "keywords": ["防犯カメラ", "スマートホーム", "見守り", "一人暮らし"],
        "category": "gadget",
    },
]
